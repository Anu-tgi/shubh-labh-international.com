...
$(document).ready(function() {
  ...
  var totalSlides = $('.slides-container .slide').length; // Get the total number of slides
  var currentSlide = 1; // Set the initial slide index

  // Set an interval to change slides every 2 seconds
  setInterval(function () {
    currentSlide = (currentSlide % totalSlides) + 1; // Calculate the next slide index
    $('.slide-navigation__txt span').eq(currentSlide - 1).click(); // Trigger click on the corresponding navigation span
